...
export { BytesStream } from "https://raw.githubusercontent.com/i-xi-dev/bytes-stream.es/3.0.23/mod.ts";
...
export { Digest } from "https://raw.githubusercontent.com/i-xi-dev/digest.es/3.0.3/mod.ts";
